...
let dataArray = [
    ...
    {showName: "Supernatural", mainCharacter: "Sam and Dean Winchester", synopsis: "Follow Sam and Dean who travel across America in a 1967 Chevy Impa;a investigating and combating pernormal events.", onGoing: false, genre: ["Mystery", "Fantasy"," Horror"], episodes: 320,  id: uuidv4()}
]
...
DataRouter
    ...
    .get('/:DataId',(req,res) => {
        ...
        const oneItem = DataId.find(item => item.id === DataId);
        res.send(oneItem)
    })
